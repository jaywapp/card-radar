...
이 디렉터리는 `D:\\work\\card-radar\\docs\\`에 있는 프로젝트 관련 문서의 기준 위치입니다.
...
- 빌드 및 실제 기능 검증: [분석](build-verification-analysis.md), [설계](build-verification-design.md), [결과](build-verification-tasks.md)
